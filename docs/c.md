...
3. To identify the capacity of hardware, for change management.
4. To allow for on-going monitoring for preventive maintenance. In systems administration, there are three steps to building a monitoring solution.
5. Select the correct and appropriate objects and counters.
6. Set up logs and alerts.
7. Understand what they mean! 

The final step cannot be taught, it requires years of experience AND frequently, rather detailed internet searches. There are two modes in which we can operate perfmon. The first mode is the most simple, real time tracking. In this mode we can select variables of interest, on the fly, evaluate their performance and perhaps do a certain amount of fault finding. 
